...
public class OrcamentoCategoriaRepository : IOrcamentoCategoriaRepository
{
    ...
    public OrcamentoCategoriaRepository(SistemaIgrejaDbContext context, ITenantContext tenantContext)
    {
        _context = context;
        _tenantContext = tenantContext;
    }

    public OrcamentoCategoriaRepository(SistemaIgrejaDbContext context)
