...
namespace SistemaIgreja.Infrastructure.Migrations
{
    ...
    [Migration("20260629223350_AdicionarSemanasDoMesExcluidasRecorrencia")]
    partial class AdicionarSemanasDoMesExcluidasRecorrencia
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SistemaIgreja.Domain.Entities.DoacaoOnline", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("FinalidadeDoacaoId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TenantId", "ReciboToken")
                        .IsUnique();

                    b.HasIndex("TenantId", "Status", "DataCriacao");

                    b.ToTable("DoacoesOnline");
                });
            ...
            modelBuilder.Entity("SistemaIgreja.Domain.Entities.EventoRecorrencia", b =>
                {
                    ...
                    b.Property<string>("SemanasDoMesExcluidas")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");
            ...
            modelBuilder.Entity("SistemaIgreja.Domain.Entities.FinalidadeDoacao", b =>
                {
                    ...
                    b.Property<bool>("PermiteCartaoCredito")
                        .HasColumnType("boolean");

                    b.Property<bool>("PermitePix")
                        .HasColumnType("boolean");
                    ...
                    b.Property<string>("ValoresSugeridos")
                        .HasMaxLength(300)
                        .HasColumnType("character varying(300)");

                    b.Property<bool>("VisivelPortal")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("TenantId", "Ativo", "VisivelPortal", "Ordem");

                    b.ToTable("FinalidadesDoacao");
                });
            ...
            modelBuilder.Entity("SistemaIgreja.Domain.Entities.GivingProviderConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("ApiKeyProtegida")
                        .HasMaxLength(4000)
                        .HasColumnType("character varying(4000)");

                    b.Property<string>("ApiKeyUltimosDigitos")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)");
                    ...
                    b.ToTable("GivingProviderConfigs");
                });
            ...
            modelBuilder.Entity("SistemaIgreja.Domain.Entities.Receita", b =>
                {
                    ...
                    b.HasIndex("TenantId", "PessoaId", "DataRecebimento");
            ...
            modelBuilder.Entity("SistemaIgreja.Domain.Entities.DoacaoOnline", b =>
                {
                    b.HasOne("SistemaIgreja.Domain.Entities.FinalidadeDoacao", "FinalidadeDoacao")
                        .WithMany()
                        .HasForeignKey("FinalidadeDoacaoId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.HasOne("SistemaIgreja.Domain.Entities.Receita", "Receita")
                        .WithMany()
