...
public class DoacoesController : ControllerBase
{
    ...
    {
        var config = await _service.GetProviderConfigAsync(SistemaIgreja.Domain.Entities.GivingProvider.Asaas);
        return Ok(config);
    }
    ...
    {
        dto.Provider = SistemaIgreja.Domain.Entities.GivingProvider.Asaas;
