    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Visão geral do sistema de gestão de visitantes
        </p>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">
            Este sistema permite gerenciar visitantes e automatizar o envio de mensagens de boas-vindas via WhatsApp.
